...
class LoginDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self.login_tab = QPushButton("??")
        self.login_tab.setObjectName("tab")
        self.register_tab = QPushButton("????")
    ...
    def _build_login_page(self) -> QWidget:
        ...
        self.login_username = self._field(layout, "???", "??????")
        self.login_password = self._field(layout, "??", "?????", password=True)
    ...
    def _build_register_page(self) -> QWidget:
        ...
        self.register_username = self._field(layout, "???", "3-64 ???")
        self.register_display_name = self._field(layout, "????", "??????????")
        self.register_password = self._field(layout, "??", "?? 6 ?", password=True)
        self.register_confirm = self._field(layout, "????", "??????", password=True)
